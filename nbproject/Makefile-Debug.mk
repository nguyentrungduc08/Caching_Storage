...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/caching_storage: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/caching_storage ${OBJECTFILES} ${LDLIBSOPTIONS} -lthriftnb -levent -lkyotocabinet -lz -lstdc++ -lrt -lpthread -lm -lc -lPocoUtil -lPocoXML -lPocoJSON -lPocoNet -lPocoFoundation
